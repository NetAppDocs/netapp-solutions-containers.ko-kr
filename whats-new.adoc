...
summary: NetApp 컨테이너 솔루션 담보 자료의 최근 변경 사항 로그입니다. 
---
= NetApp 컨테이너 솔루션의 새로운 기능
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
VMware vSphere Kubernetes Service with NetApp ONTAP 솔루션을 NetApp 컨테이너 솔루션에 추가했습니다: link:https://docs.netapp.com/us-en/netapp-solutions-containers/vsphere-kubernetes-service/vks-overview.html["vSphere Kubernetes 서비스 솔루션"^].
