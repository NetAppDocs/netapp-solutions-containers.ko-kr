...
. BIG-IP 시스템에서 명령형 명령어 대신 JSON 형식의 구성을 사용할 수 있도록 F5 Application Services 3 확장 프로그램을 설치하십시오. link:https://github.com/F5Networks/f5-appsvcs-extension/releases["F5 AS3 GitHub 저장소"^]로 이동하여 최신 RPM 파일을 다운로드하십시오.
