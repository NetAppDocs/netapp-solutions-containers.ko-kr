...
[role="lead"]
대부분의 Red Hat OpenShift 배포에서는 link:https://quay.io["Quay.io"^] 또는 link:https://hub.docker.com["도커허브"^]와 같은 공용 레지스트리를 사용하는 것으로 대부분의 고객 요구 사항을 충족할 수 있습니다. 하지만 고객이 자체적인 비공개 또는 사용자 지정 이미지를 호스팅하려는 경우도 있습니다.
