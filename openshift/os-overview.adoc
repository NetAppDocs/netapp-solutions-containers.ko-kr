...
. Red Hat에서 제공하는 link:https://docs.openshift.com/container-platform/4.7/installing/index.html["설치 지침"^] 지침에 따라 원하는 환경에 배포하십시오.
...
* link:os-on-bm.html["베어 메탈의 OpenShift"]
* link:os-on-openstack.html["Red Hat OpenStack 플랫폼의 OpenShift"]
* link:os-on-rhv.html["Red Hat Virtualization의 OpenShift"]
* link:os-on-vmw.html["VMware vSphere에서의 OpenShift"]
