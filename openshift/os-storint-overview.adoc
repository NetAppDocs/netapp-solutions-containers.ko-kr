...
[role="lead"]
NetApp Trident Protect에 대해 알아보세요. 이 솔루션은 OpenShift Virtualization 솔루션의 애플리케이션 및 영구 스토리지 관리를 위해 검증되었습니다.

Trident는 NetApp에서 유지 관리하는 오픈 소스 스토리지 프로비저너 및 오케스트레이터로, 추가 기능인 NetApp Trident Protect와 함께 Red Hat OpenShift와 같은 컨테이너 기반 환경에서 영구 데이터를 오케스트레이션하고 관리하기 위한 강력한 솔루션을 제공합니다.
...
* link:https://docs.netapp.com/us-en/trident/trident-protect/learn-about-trident-protect.html["Trident Protect 문서"]
