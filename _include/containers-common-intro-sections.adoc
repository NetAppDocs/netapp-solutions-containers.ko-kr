...
자세한 내용은 link:https://www.openshift.com["Red Hat OpenShift 웹사이트"^]을 참조하십시오.
...
자세한 내용은 link:https://www.netapp.com["NetApp 웹사이트"^]을 참조하십시오.
...
NetApp AFF/FAS 플랫폼에 대한 자세한 내용은 link:https://docs.netapp.com/platstor/index.jsp["NetApp 하드웨어 플랫폼 설명서"^]을 참조하십시오.
...
ONTAP Select에 대한 자세한 내용은 link:https://docs.netapp.com/us-en/ontap-select/["ONTAP Select 문서"^]을 참조하십시오.
...
Cloud Volumes ONTAP에 대한 자세한 내용은 link:https://docs.netapp.com/us-en/occm/#discover-whats-new["Cloud Volumes ONTAP 설명서"^]을 참조하십시오.
...
NetApp Trident는 {k8s_distribution_name} 등의 컨테이너 및 Kubernetes 배포판을 위한 오픈 소스이며 완벽하게 지원되는 스토리지 오케스트레이터입니다. 자세한 내용은 link:https://docs.netapp.com/us-en/trident/index.html["Trident 문서"^]을 참조하십시오.
