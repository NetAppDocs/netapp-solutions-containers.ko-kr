...
image:a-w-n-ontap-onpremises-virt-cloud.png["입력/출력 대화 상자 또는 서면 내용을 나타내는 그림"]
...
NetApp AFF 및 FAS 플랫폼에 대한 자세한 내용은 link:https://docs.netapp.com/platstor/index.jsp["NetApp 하드웨어 플랫폼 설명서"^]을 참조하십시오.
