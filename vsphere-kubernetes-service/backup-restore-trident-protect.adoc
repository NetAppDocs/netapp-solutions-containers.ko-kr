...
[%collapsible]
====
이 예제는  `postgres` 네임스페이스에 설치된 샘플 PostgreSQL 애플리케이션의 데이터 보호에 대해 설명합니다. 설치에 대한 자세한 내용은 link:deploy-vks-workloads.html["NetApp 스토리지를 사용하여 VKS 워크로드 배포"]을 참조하십시오.
